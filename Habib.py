#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To HabiburRahman
...
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-HabiburRahman-\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................HabiburRahman......................
\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ 
\033[1;93m║║ ║╚╣║║║║╩╣   b̲̅a̲̅n̲̅g̲̅l̲̅a̲̅d̲̅e̲̅s̲̅h̲̅
\033[1;93m╚╝ ╚═╩═╩═╩═╝═ 
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;90MHabiburRahman\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
print  """
 ...
 \033[1;96m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  \033[1;96m ─────────────•◈•──────────  
   \033[1;92m███████▒▒Welcome To My World▒▒███████
\033[1;95m♡╭──────────•h̲̅a̲̅b̲̅i̲̅b̲̅u̲̅r̲̅ r̲̅a̲̅h̲̅m̲̅a̲̅n̲̅•──────────╮♡\033[1;96mHä̤b̤̈ï̤b̤̈ṳ̈r̤̈Rä̤ḧ̤m̤̈ä̤n̤̈\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mï̤nnσcєntb̤̈σч
\033[1;90mHαвíвurRαhmαn\033[1;91m: \033[1;91▒▓██████████████]99.9
\033[1;94mFacebook\033[1;91m: \033[1;91mItz.Habib.Vau
\033[1;94mWhatsapp\033[1;91m: \033[1;91mUse Kori Na 😁
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mHabiburRahman\033[1;95m♡╰──────────•◈•──────────╯♡"""
jalan('              \033[1;96m....................HabiburRahman.....................:')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╱▔▔▔▔╲┈┈┈┈┈┈┈┈   ")
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕╲┊┊╱▏▏┈┈┈┈┈┈┈   ')
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕▂╱╲▂▏▏┈┈┈┈┈┈┈   ')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╲┊┊┊┊╱┈┈┈┈┈┈┈┈ ")
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈▕╲▂▂╱▏┈┈┈┈┈┈┈┈")
print "\033[1;93m♡─────╱▔▔▔▔┊┊┊┊▔▔▔▔╲───────♡\033[1;96mLogin HabiburRahman\033[1;95m♡╰──────────•◈•──────────╯♡"

CorrectUsername = "Habibur"
CorrectPassword = "Rahman"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Habibur_Rahman
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system(https://www.facebook.com/Itz.Habib.Vau)
    else:
...
def login():
	...
	try:
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mHabiburRahman\033[1;95m♡──────────•◈•──────────♡"
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Habibur_Rahman
	print logo
...
def pilih_super():
	...
	print """
             ...
             ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤
♡──────────────•◈•──────────────♡.
: \033[1;96m .....Habibur Rahman........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp Num
               Use Kori Na"""
